...
// @ts-ignore
 ...
 return DEFAULT_DURATIONS[text()]; };// @ts-ignore
 ...
 return v };// @ts-ignore
  ...
  var peg$f8 = function(n, i) {// @ts-ignore
 return new Node({type: 'repeat', value: n, times: i}) };// @ts-ignore

  var peg$f9 = function(dur) { 
// @ts-ignore
...
// @ts-ignore
  ...
  var peg$f10 = function(dur, i) {// @ts-ignore
 return new Node({type: 'pitch', duration: dur, value: i, pitch: parseInt(i)}) };// @ts-ignore

  var peg$f11 = function(left, right) {// @ts-ignore
...
export type Items = (Repeat | List | Item)[];
export type List = any;
export type Item = Chord | Pitch | Ws | DurationChange | List;
