...
// @ts-ignore
 ...
 return undefined };// @ts-ignore
  ...
  var peg$f2 = function(min, max) {// @ts-ignore
 return Math.floor(Math.random() * (max - min + 1) + min) };// @ts-ignore

  var peg$f3 = function(min, max) {// @ts-ignore
 return (Math.random() * (max - min) + min) };// @ts-ignore
...
// @ts-ignore
      if (s0 === peg$FAILED) {
// @ts-ignore
        s0 = peg$parserandom_int();
// @ts-ignore
        if (s0 === peg$FAILED) {
// @ts-ignore
          s0 = peg$parserandom_float();
        }
      }
    }
...
export type ParseFunction = <Options extends ParseOptions>(
    ...
    StartRule extends "lines" ? Lines : Lines
    : Lines;
...
export type SubOperations = ["(", Operation, ")"];
